...
import fr.insee.advent.Jour25.State.Action;
import fr.insee.advent.Jour25.State.Action.Way;

public class Jour25 {
	
	public static void main(String[] args) throws IOException {
		Jour25 jour = new Jour25();
		System.out.println("Jour25");
		System.out.println("1. " + jour.ex1(12_964_419 , "src/main/resources/input25"));
	}
